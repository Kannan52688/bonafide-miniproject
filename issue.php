...
$query= "SELECT * FROM office WHERE regnum='$regnum'";
...
$INSERT ="INSERT Into admin(stname,regnum,dept,year,clgname) values(?,?,?,?,?)";
$stmt = $link->prepare($INSERT);
$stmt->bind_param("sssss", $stname,$regnum,$dept,$year,$clgname);
$stmt->execute();
$delete = "DELETE FROM office WHERE regnum='$regnum'";
